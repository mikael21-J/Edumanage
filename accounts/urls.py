...
urlpatterns = [
    ...
    path('dashboard/enseignant/profil/', views.teacher_profile, name='teacher_profile'),
    ...
    path('dashboard/enseignant/ue/<str:code_ue>/<str:evaluation_type>/impression/', views.teacher_impress, name='teacher_impress'),
    path('dashboard/admin-cellule/', views.dashboard_admin_cellule, name='dashboard_admin_cellule'),
    path('dashboard/admin-cellule/pv/', views.admin_pv_list, name='admin_pv_list'),
